...
namespace elitedivision\amos\core\giiamos\model;
...
class Generator extends \yii\gii\generators\model\Generator
{
    ...
    {
        return ['model.php', 'model-extended.php', 'model-query.php'];
    }
    ...
    public function generate()
    {
        ...
        foreach ($this->getTableNames() as $tableName) {            
            ...
            $modelQueryFile = Yii::getAlias('@' . str_replace('\\', '/', $this->ns)) . '/' . $className . 'Query.php';
            if ($this->generateModelClass || !is_file($modelQueryFile)) {
                $files[] = new CodeFile(
                    $modelQueryFile,
                    $this->render('model-query.php', $params)
                );
            }
        }
        return $files;
