                        ...
                        [
                            ...
                            'buttons' => [
                                'condominio' => function ($url, $model) {
                                    ...
                                    return Html::a('<p class="btn bk-btnAssociaCondominio" title="Visualizza i dettagli del condominio"><span id="bk-btnAssociaCondominio" class="ti ti-file"></span></p>', Yii::$app->urlManager->createUrl(['admin/user-profile/vedi-condominio', 'id' => $model['id'], 'utente' => $this->model['id'], 'url' => 'tab-condominio']), [
                                                    'title' => Yii::t('yii', 'Visualizza i dettagli del condominio'),
                                        ]);                                    
                                },
                                    ],
                                ],
